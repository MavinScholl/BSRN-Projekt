...
void processVoltageMeasurements(int voltage[], int validCount) {
    // Code zur Verarbeitung der Messwerte hier einfügen
    // ...
}
...
int main() {
    ...
    while (!shouldExit) {
        ...
        processVoltageMeasurements(voltage, validCount);

        printf("\nProgramm pausiert für 5 Sekunden...\n");
        sleep(5);
    }
